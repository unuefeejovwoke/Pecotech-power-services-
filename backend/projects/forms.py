...
class ServiceRequestForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['full_name', 'email', 'phone_number', 'quotation_info', 'service_required', 'uploaded_files']
        widgets = {
            ...
            'quotation_info': forms.Textarea(attrs={'class': 'w-full border mt-1 mb-3 border-black rounded-lg outline-none p-2', 'placeholder': 'Quotation Info'}),
        }
